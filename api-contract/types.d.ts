...
export declare type ApiObject<ApiType extends ApiTypes> = ApiType extends 'rxjs' ? ApiRx : ApiPromise;
...
export declare type ContractABIMessageArgPre = ContractABIArgBasePre;
export declare type ContractABIMessageArg = ContractABIArgBase;
...
export declare type ContractABIDocs = string[];
...
export declare type ContractABIStorageLayoutPre = ContractABIStorageStructPre | ContractABIRangePre;
export declare type ContractABIStorageLayout = ContractABIStorageStruct | ContractABIRange;
...
export declare type ContractABIStoragePre = ContractABIStorageStructPre;
export declare type ContractABIStorage = ContractABIStorageStruct;
export interface ContractMessage {
    index: number;
    fn: ContractABIFn;
    def: ContractABIMessage;
}
export declare type AbiConstructors = ContractABIFn[];
export declare type AbiMessages = Record<string, ContractABIFn>;
